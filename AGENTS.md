...
- `data/imdb/` is a versioned project deliverable and the canonical dataset snapshot for the current Day 1 baseline. Keep docs, tests, and scripts consistent with that path unless the project explicitly switches datasets later.
